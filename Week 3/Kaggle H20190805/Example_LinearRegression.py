#!/usr/bin/python
"""
Example_LeastSquares.py

Use TF to perform a least squares regression for a linear problem.
...
for step in range(training_epochs):
    ...
    if step > 0:
        ...
        current_c = (the_c[step]-the_c[step-1])/the_c[step-1]
        current_m = (the_m[step]-the_m[step-1])/the_m[step-1]
        if (current_m < tolerance and current_c < tolerance) :
            
            print(" Convergence achieved at ", step, " Epochs" )
            break
