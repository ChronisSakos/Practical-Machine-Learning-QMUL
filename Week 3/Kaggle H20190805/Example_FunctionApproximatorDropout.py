#!/usr/bin/python
"""
Example_FunctionApproximatorDropout.py

Construct a single layer regression MLP to use as a function approximator. This
uses dropout.
...
dmodel       = tf.nn.dropout(layer_1, keep_prob)
