...
We adapted the Examples_LinearRegression.py script in order to find the most 
suitable number of training epochs for the fit to converge to a stable value 
of the cost
