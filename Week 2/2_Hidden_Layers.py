...
We adapted the Example_FunctionApproximator.py script and created an MLP with 
...
learning_rate    = 0.01
training_epochs  = 1000   #we examined different values of training epochs
min_x = -10
max_x = 10
Ngen  = 10000
...
probabilities = tf.matmul(layer_2, output) + bias_output
